...
This skill provides specialized capability for `xlsx` within Claude and other agent environments.

> Part of **[Skill Bazaar](../../README.md)** · [Mega AI Bazaar](https://drvivek34.github.io/Mega-AI-Bazaar/)

## Details
- **Name**: xlsx
- **Source URL**: https://github.com/anthropics/skills/tree/main/skills/xlsx
- **Author**: Anthropic
- **License**: MIT
