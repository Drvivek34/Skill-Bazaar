...
This skill provides specialized capability for `docx` within Claude and other agent environments.

> Part of **[Skill Bazaar](../../README.md)** · [Mega AI Bazaar](https://drvivek34.github.io/Mega-AI-Bazaar/)

## Details
- **Name**: docx
- **Source URL**: https://github.com/anthropics/skills/tree/main/skills/docx
- **Author**: Anthropic
- **License**: MIT
